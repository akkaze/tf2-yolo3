...
def Darknet(name=None, input_channel=3):
    x = inputs = Input([None, None, input_channel])
...
def YoloV3(size=None, channels=3, anchors=yolo_anchors, masks=yolo_anchor_masks, num_classes=10, training=False):
